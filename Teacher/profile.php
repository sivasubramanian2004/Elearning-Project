...
$username = "root"; // Update if your DB username differs
$password = "";     // Update if your DB password differs
...
if (!isset($_SESSION['teacher_id'])) {
    $_SESSION['teacher_id'] = 1; // Example teacher ID for testing
}
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    $sql = "SELECT name, email, phone, subject FROM teachers WHERE id = $teacher_id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($password) && $password !== $confirm_password) {
        ...
        $sql = "UPDATE teachers 
                SET name = '$name', phone = '$phone', subject = '$subject' $password_query 
                WHERE id = $teacher_id";
...
<body>
    <div class="container">
        ...
        <div class="dashboard-link">
            <p>Go To My Dashboard <a href="index.php">Click Here</a></p>
        </div>
    </div>
</body>
</html>
